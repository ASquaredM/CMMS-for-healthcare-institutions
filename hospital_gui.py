...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.inspectionDate_button = QtWidgets.QPushButton(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.inspectionDate_button.sizePolicy().hasHeightForWidth())
        self.inspectionDate_button.setSizePolicy(sizePolicy)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("Resources/images/calender.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.inspectionDate_button.setIcon(icon8)
        self.inspectionDate_button.setObjectName("inspectionDate_button")
        self.gridLayout_6.addWidget(self.inspectionDate_button, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.inspectionDate_button.setText(_translate("MainWindow", "13/5/2020"))
        ...
        self.q7.setText(_translate("MainWindow", "Hhhh"))
